...
function Therapists() {
  const { fakeTherapists: therapists } = useTherapists();
  ...
  return (
    <div className="  flex   flex-col items-center justify-center  gap-28 pb-5 pt-24 lg:gap-20">
      ...
      <div className=" flex max-w-[1240px]   flex-wrap items-center  justify-center gap-2 p-10  sm:gap-10  lg:justify-between">
