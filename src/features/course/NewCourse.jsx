...
function NewCourse() {
  ...
  return (
    <div className="flex items-center justify-center ">
      <div className=" mx-14 flex   h-screen w-full flex-col items-center justify-end  pb-20  text-white sm:mx-24  sm:mb-16  sm:flex-row sm:items-end sm:justify-between sm:pt-0  md:gap-5 lg:max-w-[1240px]">
        <div className=" order-2 flex flex-col pt-9 sm:order-1 ">
          <h3 className=" mb-3 text-center text-2xl md:text-4xl lg:text-5xl">
            {latestCourse.name}
          </h3>
          ...
          <div className="  lg:-mr-16">
            ...
            >
              <img src={nextIcon} className=" mt-1 w-5  text-white lg:w-10" />
              <p
                className=" mr-1 break-words    border-b border-transparent  text-[20px]  hover:border-slate-200 md:text-[28.5px] lg:text-[43px] "
